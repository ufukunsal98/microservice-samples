...
@Service
public class CustomDefaultTokenServices extends DefaultTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
        ConsumerTokenServices, InitializingBean {

    private int refreshTokenValiditySeconds; //default 30 days.

    private int accessTokenValiditySeconds; // default 12 hours.
