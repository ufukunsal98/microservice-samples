...
public class OAuth2AccessToken extends DefaultOAuth2AccessToken implements Serializable {
     ...
     * @param accessToken
     */
    public OAuth2AccessToken(OAuth2AccessToken accessToken) {
    ...
    public static DefaultOAuth2AccessToken valueOf(Map<String, String> tokenParams) {
        org.springframework.security.oauth2.common.DefaultOAuth2AccessToken token = new org.springframework.security.oauth2.common.DefaultOAuth2AccessToken(tokenParams.get(ACCESS_TOKEN));
